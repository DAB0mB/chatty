...
#### [Step 5.1: Update Schema with Relay Cursor Connection](https://github.com/srtucker22/chatty/commit/7c21b70)
...
#### [Step 5.2: Update Resolvers with Relay Cursor Connection](https://github.com/srtucker22/chatty/commit/e7622c1)
...
#### [Step 5.3: Use inverted FlatList for Messages](https://github.com/srtucker22/chatty/commit/ce1c234)
...
#### [Step 5.4: Update Group Query with Relay Cursor Connections](https://github.com/srtucker22/chatty/commit/ed0864b)
...
#### [Step 5.5: Add fetchMore to groupQuery](https://github.com/srtucker22/chatty/commit/ed8b217)
...
#### [Step 5.6: Apply loadMoreEntries to onEndReached](https://github.com/srtucker22/chatty/commit/87ee5ec)
...
#### [Step 5.7: Add most recent message to each Group in USER_QUERY](https://github.com/srtucker22/chatty/commit/63c1e5f)
...
#### [Step 5.8: Modify Group component to include latest message](https://github.com/srtucker22/chatty/commit/d5554af)
...
#### [Step 5.9: Manual Refresh Groups](https://github.com/srtucker22/chatty/commit/1df10c8)
...
#### [Step 5.10: Modify createMessage mutation to update USER_QUERY](https://github.com/srtucker22/chatty/commit/3f47310)
...
| [< Previous Step](https://github.com/srtucker22/chatty/tree/master@4.0.0/.tortilla/manuals/views/step4.md) | [Next Step >](https://github.com/srtucker22/chatty/tree/master@4.0.0/.tortilla/manuals/views/step6.md) |
|:--------------------------------|--------------------------------:|
